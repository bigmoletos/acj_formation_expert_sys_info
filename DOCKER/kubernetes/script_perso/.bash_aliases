...
alias sdn="sudo nano "  # alias pour lancer un nano en mode sudo
alias sdc="sudo cat "   # alias pour lancer un cat en mode sudo
alias sd="sudo  "       # alias pour lancer un sudo
